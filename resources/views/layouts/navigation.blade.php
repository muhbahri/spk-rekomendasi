            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user() && Auth::user()->role === 'admin')
                        <x-nav-link :href="route('admin.negara.index')" :active="request()->routeIs('admin.negara.*')">
                            {{ __('Negara') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('admin.pertanyaan.index')" :active="request()->routeIs('admin.pertanyaan.*')">
                            {{ __('Pertanyaan') }}
                        </x-nav-link>

                        <x-nav-link :href="route('admin.bobot-negara.index')" :active="request()->routeIs('admin.bobot-negara.*')">
                            {{ __('Bobot Negara') }}
                        </x-nav-link>
                    @endif
                </div>
